...
# Supported Modules
- General module for all other aircraft not listed here
...
**TLDR**: Replace the `Scripts/wwt` folder with the downloaded  <a href="https://github.com/llamaXc/winwing-ufc-addon/releases/download/V1.0.17/wwt.zip" download>Latest Release wwt<a/>.

Install Video: https://www.youtube.com/watch?v=_H_wJi3YCuY

 1. Download the <a href="https://github.com/llamaXc/winwing-ufc-addon/releases/download/V1.0.17/wwt.zip" download>Latest Release<a/>
