...
**TLDR**: Replace the `Scripts/wwt` folder with the downloaded  <a href="https://github.com/llamaXc/winwing-ufc-addon/releases/download/V1.0.16/wwt.zip" download>Latest Release wwt<a/>.

Install Video: https://www.youtube.com/watch?v=_H_wJi3YCuY&t=24s&ab_channel=PapiPlanes

 1. Download the <a href="https://github.com/llamaXc/winwing-ufc-addon/releases/download/V1.0.16/wwt.zip" download>Latest Release<a/>
