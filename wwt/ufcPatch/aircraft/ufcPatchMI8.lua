...
function ufcPatchMI8.generateUFCData()
	...
	--ARK 9
	local ARK9BDialdigits = {
		math.floor((MainPanel:get_argument_value(675) * 21) + 1), --Add since 0 is Channel 1, number for multiplation due to Arg rounding requirements
	...
	local ARK9PDialdigits = {
		math.floor((MainPanel:get_argument_value(678) * 21) + 1), --Add since 0 is Channel 1, number for multiplation due to Arg rounding requirements
