...
function ufcPatchF15e.generateUFCData()
    ...
    local UFC = ufcUtils.getDCSListIndication(8)
    local WSO_MFD1	= ufcUtils.getDCSListIndication(12)
    local WSO_MFD2  = ufcUtils.getDCSListIndication(14)
    local WSO_MFD3  = ufcUtils.getDCSListIndication(16)
    local WSO_MFD4	= ufcUtils.getDCSListIndication(18)
    local WSO_UFC = ufcUtils.getDCSListIndication(20)
